    ...
    ***************************************************************************** */
    ...
    var ConfigService = /** @class */ (function () {
        ...
        ConfigService = __decorate([
            core.Injectable(),
            __param(0, core.Inject(CONFIG_OPTIONS)),
    ...
    var Oauth1Service = /** @class */ (function () {
        ...
        Oauth1Service = __decorate([
            core.Injectable(),
            __metadata("design:paramtypes", [http.HttpClient, PopupService, ConfigService])
        ], Oauth1Service);
    ...
    var OauthService = /** @class */ (function () {
        ...
        OauthService = __decorate([
            core.Injectable(),
            __metadata("design:paramtypes", [http.HttpClient, SharedService, ConfigService, PopupService])
        ], OauthService);
        return OauthService;
    }());
    ...
    var LocalService = /** @class */ (function () {
        ...
        LocalService = __decorate([
            core.Injectable(),
            __metadata("design:paramtypes", [http.HttpClient, SharedService, ConfigService])
        ], LocalService);
        return LocalService;
    }());
